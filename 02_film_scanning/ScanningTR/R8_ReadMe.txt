...
└── _R8_131
    ├── mov_2048x1536
    │   ├── 20220419_Bowser_Pearl_R8_131.mov
    │   └── 20220419_Bowser_Pearl_R8_131_overscan.mov
    ├── mp4_1920x1080
    │   └── 20220419_Bowser_Pearl_R8_131_overscan.mp4
    └── mp4_2048x1536
        ├── 20220419_Bowser_Pearl_R8_131.mp4
        └── 20220419_Bowser_Pearl_R8_131_overscan.mp4

4 directories, 5 files

This presumes a project named 'Bowser_Pearl' a reel named 'R8_131' and a selection of all the available pre-made outputs.

A project named 'Bowser_Pearl' means a ScanStation project file named 'Bowser_Pearl'

Example: Bowser_Pearl.cdir

To achieve this open the R8_2K_MOS_Color.cdir file and 'save as' a new file named 'Bowser_Pearl'

To achieve a reel named 'R8_131' go to 'Job Settings' and, at the top, change 'Reel Name' to 'R8_131'
...
YYYMMDD_Bowser_Pearl_R8_131.mov or YYYMMDD_Bowser_Pearl_R8_131.mp4, depending on the Output(s) chosen. If the film was scanned
on April 19, 2022 the resulting file name would be '20220419_Bowser_Pearl_R8_131.mov'

The over-scanned Output 'Prefix' setting is:

++ %date%_%job%_%reel%_overscan
following the same variable substitution logic as the 'Output Path' setting defined in section number 2 above, this will give us a file named 
YYYMMDD_Bowser_Pearl_R8_131_overscan.mov or YYYMMDD_Bowser_Pearl_R8_131_overscan.mp4, depending on the Output(s) chosen.
